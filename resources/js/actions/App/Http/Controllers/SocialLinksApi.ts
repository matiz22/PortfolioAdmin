...
/**
* @see \App\Http\Controllers\SocialLinksApi::all
* @see app/Http/Controllers/SocialLinksApi.php:24
...
/**
* @see \App\Http\Controllers\SocialLinksApi::byId
* @see app/Http/Controllers/SocialLinksApi.php:37
* @route '/api/v1/social-links/{id}'
*/
...
/**
* @see \App\Http\Controllers\SocialLinksApi::allTranslated
* @see app/Http/Controllers/SocialLinksApi.php:73
* @route '/api/v1/social-links/translated'
*/
...
allTranslated.definition = {
    methods: ["get","head"],
    url: '/api/v1/social-links/translated',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\SocialLinksApi::translated
* @see app/Http/Controllers/SocialLinksApi.php:85
* @route '/api/v1/social-links/translated/{id}'
*/
...
translated.definition = {
    methods: ["get","head"],
    url: '/api/v1/social-links/translated/{id}',
} satisfies RouteDefinition<["get","head"]>
...
const SocialLinksApi = { all, byId, allTranslated, translated }
