...
/**
* @see \App\Http\Controllers\JobsApi::all
* @see app/Http/Controllers/JobsApi.php:24
* @route '/api/v1/jobs'
*/
...
/**
* @see \App\Http\Controllers\JobsApi::byId
* @see app/Http/Controllers/JobsApi.php:37
...
/**
* @see \App\Http\Controllers\JobsApi::home
* @see app/Http/Controllers/JobsApi.php:17
* @route '/api/v1/jobs/home-page'
*/
...
/**
* @see \App\Http\Controllers\JobsApi::allTranslated
* @see app/Http/Controllers/JobsApi.php:73
* @route '/api/v1/jobs/translated'
*/
...
/**
* @see \App\Http\Controllers\JobsApi::translated
* @see app/Http/Controllers/JobsApi.php:85
* @route '/api/v1/jobs/translated/{id}'
*/
...
/**
* @see \App\Http\Controllers\JobsApi::homeTranslated
* @see app/Http/Controllers/JobsApi.php:27
* @route '/api/v1/jobs/translated/home-page'
*/
...
homeTranslated.definition = {
    methods: ["get","head"],
    url: '/api/v1/jobs/translated/home-page',
} satisfies RouteDefinition<["get","head"]>
...
const JobsApi = { all, byId, home, allTranslated, translated, homeTranslated }
